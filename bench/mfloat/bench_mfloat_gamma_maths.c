...
int main(void)
{
    ...
    puts("");
    run_unary_case("gamma_2_345_256", "2.345", 256u, mf_gamma, bench_scaled_iters(2));
    run_unary_case("lgamma_2_345_256", "2.345", 256u, mf_lgamma, bench_scaled_iters(2));
    run_unary_case("gamma_2_345_512", "2.345", 512u, mf_gamma, bench_scaled_iters(2));
    run_unary_case("lgamma_2_345_512", "2.345", 512u, mf_lgamma, bench_scaled_iters(2));
    run_unary_case("gamma_2_345_768", "2.345", 768u, mf_gamma, bench_scaled_iters(2));
    run_unary_case("lgamma_2_345_768", "2.345", 768u, mf_lgamma, bench_scaled_iters(2));
    run_unary_case("gamma_2_345_1024", "2.345", 1024u, mf_gamma, bench_scaled_iters(1));
    run_unary_case("lgamma_2_345_1024", "2.345", 1024u, mf_lgamma, bench_scaled_iters(1));
