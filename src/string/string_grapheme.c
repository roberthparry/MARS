...
static const cp_range_t spacing_mark_ranges[] = {
    {0x0900, 0x0903},   {0x093B, 0x093C},   {0x093E, 0x0940},   {0x0949, 0x094C},   {0x094E, 0x094F},
    {0x0982, 0x0983},   {0x09BE, 0x09C0},   {0x09C7, 0x09C8},   {0x09CB, 0x09CC},   {0x09D7, 0x09D7},
    {0x0A03, 0x0A03},   {0x0A3E, 0x0A40},   {0x0A83, 0x0A83},   {0x0ABE, 0x0AC0},   {0x0AC9, 0x0AC9},
    {0x0ACB, 0x0ACC},   {0x0B02, 0x0B03},   {0x0B3E, 0x0B3E},   {0x0B40, 0x0B40},   {0x0B47, 0x0B48},
    {0x0B4B, 0x0B4C},   {0x0B57, 0x0B57},   {0x0BBE, 0x0BBF},   {0x0BC1, 0x0BC2},   {0x0BC6, 0x0BC8},
    {0x0BCA, 0x0BCC},   {0x0BD7, 0x0BD7},   {0x0C01, 0x0C03},   {0x0C41, 0x0C44},   {0x0C82, 0x0C83},
    {0x0CBE, 0x0CBE},   {0x0CC0, 0x0CC4},   {0x0CC7, 0x0CC8},   {0x0CCA, 0x0CCB},   {0x0CD5, 0x0CD6},
    {0x0D02, 0x0D03},   {0x0D3E, 0x0D40},   {0x0D46, 0x0D48},   {0x0D4A, 0x0D4C},   {0x0D57, 0x0D57},
    {0x0DCF, 0x0DD1},   {0x0DD8, 0x0DDF},   {0x0DF2, 0x0DF3},   {0x0F3E, 0x0F3F},   {0x0F7F, 0x0F7F},
    {0x102B, 0x102C},   {0x1031, 0x1031},   {0x1038, 0x1038},   {0x103B, 0x103C},   {0x1056, 0x1057},
    {0x1062, 0x1062},   {0x1067, 0x1068},   {0x1083, 0x1084},   {0x1087, 0x108C},   {0x108F, 0x108F},
    {0x109A, 0x109C},   {0x17B6, 0x17B6},   {0x17BE, 0x17C5},   {0x17C7, 0x17C8},   {0x1923, 0x1926},
    {0x1929, 0x192B},   {0x1930, 0x1931},   {0x1933, 0x1938},   {0x19B0, 0x19C0},   {0x19C8, 0x19C9},
    {0x1A19, 0x1A1A},   {0x1A55, 0x1A55},   {0x1A57, 0x1A57},   {0x1A6D, 0x1A72},   {0x1B04, 0x1B04},
    {0x1B35, 0x1B35},   {0x1B3B, 0x1B3B},   {0x1B3D, 0x1B41},   {0x1B43, 0x1B44},   {0x1B82, 0x1B82},
    {0x1BA1, 0x1BA1},   {0x1BA6, 0x1BA7},   {0x1BAA, 0x1BAA},   {0x1BE7, 0x1BE7},   {0x1BEA, 0x1BEC},
    {0x1BEE, 0x1BEE},   {0x1BF2, 0x1BF3},   {0x1C24, 0x1C2B},   {0x1C34, 0x1C35},   {0x1CE1, 0x1CE1},
    {0x1CF2, 0x1CF3},   {0x1CF7, 0x1CF7},   {0xA823, 0xA824},   {0xA827, 0xA827},   {0xA880, 0xA881},
    {0xA8B4, 0xA8C3},   {0xA952, 0xA953},   {0xA983, 0xA983},   {0xA9B4, 0xA9B5},   {0xA9BA, 0xA9BB},
    {0xA9BD, 0xA9C0},   {0xAA2F, 0xAA30},   {0xAA33, 0xAA34},   {0xAA4D, 0xAA4D},   {0xAAEB, 0xAAEB},
    ...
    {0x110B7, 0x110B8}, {0x1112C, 0x1112C}, {0x11182, 0x11182}, {0x111B3, 0x111B5}, {0x111BF, 0x111C0},
    {0x1122C, 0x1122E}, {0x11232, 0x11233}, {0x11235, 0x11235}, {0x112E0, 0x112E2}, {0x11302, 0x11303},
    {0x1133F, 0x1133F}, {0x11341, 0x11344}, {0x11347, 0x11348}, {0x1134B, 0x1134D}, {0x11362, 0x11363},
    {0x11435, 0x11437}, {0x11440, 0x11441}, {0x11443, 0x11445},
};

static const cp_range_t extended_pictographic_ranges[] = {
    {0x00A9, 0x00A9},   {0x00AE, 0x00AE},   {0x203C, 0x203C},   {0x2049, 0x2049},   {0x20E3, 0x20E3},
    {0x2122, 0x2122},   {0x2139, 0x2139},   {0x2194, 0x2199},   {0x21A9, 0x21AA},   {0x231A, 0x231B},
    {0x2328, 0x2328},   {0x23CF, 0x23CF},   {0x23E9, 0x23F3},   {0x23F8, 0x23FA},   {0x24C2, 0x24C2},
    ...
    {0x2663, 0x2663},   {0x2665, 0x2666},   {0x2668, 0x2668},   {0x267B, 0x267B},   {0x267E, 0x267F},
    {0x2692, 0x2697},   {0x2699, 0x2699},   {0x269B, 0x269C},   {0x26A0, 0x26A1},   {0x26AA, 0x26AB},
    {0x26B0, 0x26B1},   {0x26BD, 0x26BE},   {0x26C4, 0x26C5},   {0x26CE, 0x26CF},   {0x26D1, 0x26D1},
    ...
    {0x3299, 0x3299},   {0x1F000, 0x1F02F}, {0x1F0CF, 0x1F0CF}, {0x1F170, 0x1F171}, {0x1F17E, 0x1F17F},
    {0x1F18E, 0x1F18E}, {0x1F191, 0x1F19A}, {0x1F1E0, 0x1F1FF}, {0x1F201, 0x1F202}, {0x1F21A, 0x1F21A},
    {0x1F22F, 0x1F22F}, {0x1F232, 0x1F23A}, {0x1F250, 0x1F251}, {0x1F300, 0x1F6FF}, {0x1F700, 0x1F77F},
    {0x1F780, 0x1F7FF}, {0x1F800, 0x1F8FF}, {0x1F900, 0x1F9FF}, {0x1FA00, 0x1FA6F}, {0x1FA70, 0x1FAFF},
};
...
grapheme_class_t string_grapheme_class(uint32_t cp)
{
    ...
    if (range_contains(regional_indicator_ranges, ARRAY_COUNT(regional_indicator_ranges), cp))
        return GB_Regional_Indicator;

    if (range_contains(extended_pictographic_ranges, ARRAY_COUNT(extended_pictographic_ranges), cp))
        return GB_Extended_Pictographic;

    if (range_contains(combining_mark_ranges, ARRAY_COUNT(combining_mark_ranges), cp))
        return GB_Extend;

    if (range_contains(spacing_mark_ranges, ARRAY_COUNT(spacing_mark_ranges), cp))
    ...
    while (pos < len) {
        ...
        if (cls2 == GB_Extend || cls2 == GB_SpacingMark) {
            ...
            if (pos < len) {
                ...
                if (range_contains(extended_pictographic_ranges, ARRAY_COUNT(extended_pictographic_ranges), cp3))
                    pos += adv3;
            }
        } else {
            break;
...
size_t string_grapheme_prev(const char *s, size_t len, size_t i)
{
    ...
    while (anchor > 0) {
        ...
        grapheme_class_t cls = string_grapheme_class(cp);
        if (cls == GB_Extend || cls == GB_ZWJ || cls == GB_SpacingMark || cls == GB_Regional_Indicator) {
            anchor = prev;
        } else {
            break;
        }
...
{
    return rune._opaque[0] == 0u && rune._opaque[2] == RUNE_INLINE_ASCII_TAG && rune._opaque[1] > 0u &&
           rune._opaque[1] <= 0x7fu;
}

static bool rune_is_inline_scalar(rune_t rune)
{
    return rune._opaque[0] == 0u && rune._opaque[2] == RUNE_INLINE_SCALAR_TAG;
}
...
static const char *rune_data(rune_t rune)
{
    ...
    return (owner && rune_length(rune) > 0u) ? owner->data + rune_offset(rune) : NULL;
}
...
{
    return !rune_is_inline_ascii(rune) && !rune_is_inline_scalar(rune) && !rune_data(rune);
}
...
{
    return (cp >= '0' && cp <= '9') || (cp >= 0x0660u && cp <= 0x0669u) || (cp >= 0x06f0u && cp <= 0x06f9u) ||
           (cp >= 0xff10u && cp <= 0xff19u);
}

static bool rune_value_is_common_control(uint32_t cp)
{
    return cp <= 0x001fu || cp == 0x007fu || (cp >= 0x0080u && cp <= 0x009fu);
}

static bool rune_value_is_common_alpha(uint32_t cp)
{
    return (cp >= 'A' && cp <= 'Z') || (cp >= 'a' && cp <= 'z') || (cp >= 0x00c0u && cp <= 0x02afu) ||
           (cp >= 0x0370u && cp <= 0x03ffu) || (cp >= 0x0400u && cp <= 0x052fu) || (cp >= 0x1d00u && cp <= 0x1d7fu);
}
#endif
...
bool rune_is_alpha_numeric(rune_t rune)
{
    ...
    if (cp == 0u)
        return false;
#ifdef HAVE_UNISTRING
    return uc_is_property_alphabetic((ucs4_t)cp) || uc_is_property_decimal_digit((ucs4_t)cp);
#else
    return rune_value_is_common_alpha(cp) || rune_value_is_common_digit(cp);
#endif
}
...
bool rune_is_fraction(rune_t rune)
{
    ...
    return (cp >= 0x00BCu && cp <= 0x00BEu) || cp == 0x2044u || (cp >= 0x2150u && cp <= 0x215Eu);
}
