...
static struct _mint_t mr_half_num_mint = {
    .sign = 1,
    .length = 1,
    .capacity = 1,
    .storage = mr_half_num_storage
};
static struct _mint_t mr_half_den_mint = {
    .sign = 1,
    .length = 1,
    .capacity = 1,
    .storage = mr_half_den_storage
};
static struct _mint_t mr_three_num_mint = {
    .sign = 1,
    .length = 1,
    .capacity = 1,
    .storage = mr_three_num_storage
};
static struct _mint_t mr_third_den_mint = {
    .sign = 1,
    .length = 1,
    .capacity = 1,
    .storage = mr_third_den_storage
};
static struct _mint_t mr_quarter_den_mint = {
    .sign = 1,
    .length = 1,
    .capacity = 1,
    .storage = mr_quarter_den_storage
};
static struct _mint_t mr_sixth_den_mint = {
    .sign = 1,
    .length = 1,
    .capacity = 1,
    .storage = mr_sixth_den_storage
};
static struct _mint_t mr_eighth_den_mint = {
    .sign = 1,
    .length = 1,
    .capacity = 1,
    .storage = mr_eighth_den_storage
};
static struct _mint_t mr_tenth_den_mint = {
    .sign = 1,
    .length = 1,
    .capacity = 1,
