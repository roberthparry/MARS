...
const expr_ops_t ops_arbitrary_function = {.eval = eval_arbitrary_function,
                                           ...
                                           .expression_name = "arbitrary-function",
                                           .function_name = "arbitrary-function",
                                           .TeX_name = NULL,
                                           .apply_unary = NULL,
                                           .apply_binary = NULL,
                                           .simplify = expr_simplify_passthrough,
...
const expr_ops_t ops_integral_meta = {.eval = eval_integral_meta,
                                      ...
                                      .arity = EXPR_OP_BINARY,
                                      .diff_kind = EXPR_DIFF_SMOOTH,
                                      .expression_name = "integral_meta",
                                      .function_name = "integral_meta",
                                      .TeX_name = NULL,
                                      .apply_unary = NULL,
...
const expr_ops_t ops_integral_bounds = {.eval = eval_integral_bounds,
                                        ...
                                        .arity = EXPR_OP_BINARY,
                                        .diff_kind = EXPR_DIFF_SMOOTH,
                                        .expression_name = "integral_bounds",
                                        .function_name = "integral_bounds",
                                        .TeX_name = NULL,
                                        .apply_unary = NULL,
