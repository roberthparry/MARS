...
#error "expr_integrate_internal.h is private to the expression integration implementation; include expression.h instead."
#endif
...
expr_t * integrate_affine_unary_kind                        (const expr_t *expr,
                                                             ...
                                                             number_t sign);
expr_t * integrate_linear_poly_times_inverse_affine         (const expr_t *expr,
                                                             const expr_t *wrt,
                                                             expr_pattern_unary_affine_kind_t kind);
