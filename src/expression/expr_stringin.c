...
static const func_entry_t s_funcs[FUNC_TABLE_SIZE] = {
    ...
    [73 ] = { .kw = "ζ'",                 .arity = UINT_MAX, .ops = &ops_zetap,          .ufn = expr_zetap, .vfn = expr_zetap_from_args },
    ...
    [100] = { .kw = "appell_f1",          .arity = 6u,                                   .sfn = expr_appell_f1 },
    ...
    [111] = { .kw = "acoth",              .arity = 1u,       .ops = &ops_acoth,          .ufn = expr_acoth },
    [112] = { .kw = "F₁",                 .arity = 6u,                                   .sfn = expr_appell_f1 },
    [113] = { .kw = "W0",                 .arity = 1u,       .ops = &ops_lambert_w0,     .ufn = expr_lambert_w0 },
    [114] = { .kw = "zeta2",              .arity = 2u,       .ops = &ops_zetah,          .bfn = expr_zetah },
    [115] = { .kw = "lambert_wm1",        .arity = 1u,       .ops = &ops_lambert_wm1,    .ufn = expr_lambert_wm1 },
    [116] = { .kw = "tanh",               .arity = 1u,       .ops = &ops_tanh,           .ufn = expr_tanh },
    [117] = { .kw = "modinv",             .arity = 2u,       .ops = &ops_modinv,         .bfn = expr_modinv },
    [118] = { .kw = "lerch_phi",          .arity = 3u,       .ops = &ops_lerch_phi,      .tfn = expr_lerch_phi },
    [119] = { .kw = "coth",               .arity = 1u,       .ops = &ops_coth,           .ufn = expr_coth },
    [120] = { .kw = "betapdf",            .arity = 3u,                                   .tfn = expr_beta_pdf },
    ...
    [165] = { .kw = "asin",               .arity = 1u,       .ops = &ops_asin,           .ufn = expr_asin },
    [166] = { .kw = "or",                 .arity = 2u,       .ops = &ops_bit_or,         .bfn = expr_bit_or },
    ...
    [174] = { .kw = "sin",                .arity = 1u,       .ops = &ops_sin,            .ufn = expr_sin },
    [175] = { .kw = "acsc",               .arity = 1u,       .ops = &ops_acosec,         .ufn = expr_acosec },
    [176] = { .kw = "gamma",              .arity = 1u,       .ops = &ops_gamma,          .ufn = expr_gamma },
    [177] = { .kw = "normalcdf",          .arity = 1u,       .ops = &ops_normal_cdf,     .ufn = expr_normal_cdf },
    [178] = { .kw = "trigamma",           .arity = 1u,       .ops = &ops_trigamma,       .ufn = expr_trigamma },
    [179] = { .kw = "erf",                .arity = 1u,       .ops = &ops_erf,            .ufn = expr_erf },
    [180] = { .kw = "nextprime",          .arity = 1u,       .ops = &ops_next_prime,     .ufn = expr_next_prime },
    [181] = { .kw = "ψ",                  .arity = 2u,       .ops = &ops_polygamma,      .bfn = expr_polygamma_xp },
    ...
    [189] = { .kw = "ln",                 .arity = 1u,       .ops = &ops_log,            .ufn = expr_ln },
    [190] = { .kw = "F1",                 .arity = 6u,                                   .sfn = expr_appell_f1 },
    ...
    [223] = { .kw = "gammaincp",          .arity = 2u,       .ops = &ops_gammainc_P,     .bfn = expr_gammainc_P },
};
// clang-format on
