...
|---|---:|---:|---:|---:|
| `mc_exp(0.567 + 0.321i)` | `28.767 ms` | `36.573 ms` | `69.519 ms` | `104.562 ms` |
| `mc_log(0.567 + 0.321i)` | `3.337 ms` | `5.808 ms` | `10.060 ms` | `20.321 ms` |
| `mc_sqrt(0.567 + 0.321i)` | `0.306 ms` | `0.285 ms` | `0.301 ms` | `0.239 ms` |
| `mc_sin(0.567 + 0.321i)` | `186.596 ms` | `169.508 ms` | `672.041 ms` | `535.795 ms` |
| `mc_cos(0.567 + 0.321i)` | `332.183 ms` | `179.221 ms` | `488.116 ms` | `837.319 ms` |
| `mc_tan(0.567 + 0.321i)` | `127.018 ms` | `123.688 ms` | `303.435 ms` | `425.385 ms` |
| `mc_atan(0.321 + 0.123i)` | `34.772 ms` | `37.547 ms` | `53.785 ms` | `87.996 ms` |
| `mc_asin(0.321 + 0.123i)` | `2989.313 ms` | `5451.324 ms` | `5078.345 ms` | `6434.956 ms` |
| `mc_acos(0.321 + 0.123i)` | `2438.677 ms` | `10068.481 ms` | `4766.034 ms` | `4173.155 ms` |
| `mc_atan2(0.5 + 0.25i, -0.75 + 0.1i)` | `2599.634 ms` | `4694.402 ms` | `7731.552 ms` | `13324.621 ms` |
| `mc_sinh(0.567 + 0.321i)` | `149.462 ms` | `136.713 ms` | `224.701 ms` | `357.044 ms` |
| `mc_cosh(0.567 + 0.321i)` | `154.512 ms` | `140.860 ms` | `237.240 ms` | `359.918 ms` |
| `mc_tanh(0.567 + 0.321i)` | `83.694 ms` | `84.998 ms` | `127.538 ms` | `219.473 ms` |
| `mc_asinh(0.321 + 0.123i)` | `933.103 ms` | `778.943 ms` | `1392.137 ms` | `1164.640 ms` |
| `mc_acosh(2 + 0.5i)` | `714.924 ms` | `1063.271 ms` | `1500.871 ms` | `2145.106 ms` |
| `mc_atanh(0.321 + 0.123i)` | `10.353 ms` | `20.163 ms` | `27.913 ms` | `27.665 ms` |
| `mc_lambert_w0(1 + 1i)` | `190.043 ms` | `271.571 ms` | `612.529 ms` | `830.352 ms` |
| `mc_lambert_wm1(-0.2 - 0.1i)` | `621.731 ms` | `1077.192 ms` | `1171.797 ms` | `1499.533 ms` |
| `mc_productlog(1 + 1i)` | `188.065 ms` | `272.502 ms` | `612.925 ms` | `838.069 ms` |
| `mc_gamma(1.5 + 0.7i)` | `139.534 ms` | `207.277 ms` | `326.392 ms` | `466.595 ms` |
| `mc_lgamma(1.5 + 0.7i)` | `118.553 ms` | `174.009 ms` | `275.372 ms` | `413.527 ms` |
| `mc_digamma(2 + 1i)` | `20.473 ms` | `28.400 ms` | `43.483 ms` | `70.894 ms` |
| `mc_trigamma(2 + 0.5i)` | `19.394 ms` | `66.752 ms` | `69.030 ms` | `54.240 ms` |
| `mc_tetragamma(2 + 0.5i)` | `22.338 ms` | `29.573 ms` | `56.387 ms` | `169.760 ms` |
| `mc_ei(1 + 1i)` | `1.501 ms` | `2.914 ms` | `4.150 ms` | `6.879 ms` |
| `mc_e1(1 + 1i)` | `1.387 ms` | `2.991 ms` | `4.157 ms` | `6.330 ms` |
