...
|---|---:|---:|---:|---:|
| `mf_exp(1.23456789)` | `3.078 ms` | `24.625 ms` | `10.685 ms` | `26.585 ms` |
...
| `mf_sincos(0.7)` | `4.609 ms` | `4.152 ms` | `12.729 ms` | `21.773 ms` |
| `mf_tan(0.7)` | `0.435 ms` | `1.055 ms` | `5.673 ms` | `17.327 ms` |
...
| `mf_gamma(2.345)` | `36.555 ms` | `47.962 ms` | `115.839 ms` | `256.637 ms` |
| `mf_lgamma(2.345)` | `20.408 ms` | `39.435 ms` | `143.665 ms` | `199.727 ms` |
