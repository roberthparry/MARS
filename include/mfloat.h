...
extern const mfloat_t * const MF_PI_3;
extern const mfloat_t * const MF_2_PI;
...
extern const mfloat_t * const MF_SQRT_HALF;
extern const mfloat_t * const MF_SQRT2;
extern const mfloat_t * const MF_SQRT3;
extern const mfloat_t * const MF_SQRT2_OVER_TWO;
extern const mfloat_t * const MF_SQRT3_OVER_TWO;
extern const mfloat_t * const MF_SQRT_2PI;
extern const mfloat_t * const MF_SQRT_PI;
extern const mfloat_t * const MF_SQRT_PI_OVER_TWO;
extern const mfloat_t * const MF_SQRT1ONPI;
extern const mfloat_t * const MF_2_SQRTPI;
extern const mfloat_t * const MF_NEG_TWO_OVER_SQRT_PI;
extern const mfloat_t * const MF_INV_SQRT_2PI;
extern const mfloat_t * const MF_LOG_SQRT_2PI;
extern const mfloat_t * const MF_LN_2PI;
extern const mfloat_t * const MF_PI_SQUARED;
extern const mfloat_t * const MF_2PI_CUBED;
