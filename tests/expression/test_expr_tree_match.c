...
static bool expr_match_unary_affine_kind_qf_local(const expr_t *expr, expr_pattern_unary_affine_kind_t unary_kind,
                                                  size_t nvars, expr_t *const *vars, qfloat_t *constant_out,
                                                  qfloat_t *coeffs_out)
{
...
static bool expr_match_affine_poly_deg4_qf_local(const expr_t *expr, size_t nvars, expr_t *const *vars,
                                                 qfloat_t *poly_coeffs_out, qfloat_t *constant_out,
                                                 qfloat_t *coeffs_out)
{
    number_t constant = number_invalid();
    number_t poly_num[5];
...
static bool expr_match_affine_poly_deg4_times_unary_affine_kind_qf_local(const expr_t *expr,
                                                                         expr_pattern_unary_affine_kind_t unary_kind,
                                                                         size_t nvars, expr_t *const *vars,
                                                                         qfloat_t *poly_coeffs_out,
                                                                         qfloat_t *constant_out, qfloat_t *coeffs_out)
{
    number_t constant = number_invalid();
    number_t poly_num[5];
    number_t *coeffs_num = NULL;
    ...
    for (size_t i = 0; i < 5; ++i)
        poly_num[i] = number_invalid();
    ok = expr_match_affine_poly_deg4_times_unary_affine_kind(expr, unary_kind, nvars, vars, poly_num, &constant,
                                                             coeffs_num);
    if (ok)
        *constant_out = num_to_qfloat(constant);
    if (ok) {
...
#define expr_match_unary_affine_kind(...) expr_match_unary_affine_kind_qf_local(__VA_ARGS__)
#define expr_match_affine_poly_deg4(...) expr_match_affine_poly_deg4_qf_local(__VA_ARGS__)
...
static void test_match_affine_families(void)
{
    ...
    ASSERT_TRUE(expr_match_unary_affine_kind(exp_affine, EXPR_PATTERN_UNARY_EXP, 2, vars, &constant, coeffs));
    ...
    ASSERT_TRUE(expr_match_unary_affine_kind(sin_affine, EXPR_PATTERN_UNARY_SIN, 2, vars, &constant, coeffs));
...
static void test_generic_unary_affine_matchers(void)
{
    ...
    ASSERT_TRUE(!expr_match_unary_affine_kind(sin_affine, EXPR_PATTERN_UNARY_COS, 2, vars, &constant, coeffs));
...
static void test_tree_match_rejections(void)
{
    ...
    ASSERT_TRUE(!expr_match_unary_affine_kind(exp_xy, EXPR_PATTERN_UNARY_EXP, 2, vars, &constant, coeffs));
...
static void test_affine_times_exp_affine_matcher(void)
{
    ...
    ASSERT_TRUE(expr_match_affine_poly_deg4_times_unary_affine_kind(expr, EXPR_PATTERN_UNARY_EXP, 2, vars,
                                                                    (qfloat_t[5]){0}, &constant, coeffs));
    ...
    ASSERT_TRUE(!expr_match_affine_poly_deg4_times_unary_affine_kind(mismatch, EXPR_PATTERN_UNARY_EXP, 2, vars,
                                                                     (qfloat_t[5]){0}, &constant, coeffs));
...
static void test_square_affine_times_exp_affine_matcher(void)
{
    ...
    ASSERT_TRUE(expr_match_affine_poly_deg4_times_unary_affine_kind(expr, EXPR_PATTERN_UNARY_EXP, 2, vars, poly,
                                                                    &constant, coeffs));
    ...
    ASSERT_TRUE(expr_match_affine_poly_deg4_times_unary_affine_kind(expr_pow, EXPR_PATTERN_UNARY_EXP, 2, vars, poly,
                                                                    &constant, coeffs));
    ASSERT_TRUE(!expr_match_affine_poly_deg4_times_unary_affine_kind(mismatch, EXPR_PATTERN_UNARY_EXP, 2, vars, poly,
                                                                     &constant, coeffs));
...
static void test_square_affine_times_trig_affine_matchers(void)
{
    ...
    ASSERT_TRUE(expr_match_affine_poly_deg4_times_unary_affine_kind(sin_expr, EXPR_PATTERN_UNARY_SIN, 2, vars, poly,
                                                                    &constant, coeffs));
    ...
    ASSERT_TRUE(expr_match_affine_poly_deg4_times_unary_affine_kind(cos_expr, EXPR_PATTERN_UNARY_COS, 2, vars, poly,
                                                                    &constant, coeffs));
    ...
    ASSERT_TRUE(!expr_match_affine_poly_deg4_times_unary_affine_kind(mismatch, EXPR_PATTERN_UNARY_SIN, 2, vars, poly,
                                                                     &constant, coeffs));
    ASSERT_TRUE(!expr_match_affine_poly_deg4_times_unary_affine_kind(mismatch, EXPR_PATTERN_UNARY_COS, 2, vars, poly,
                                                                     &constant, coeffs));
...
static void test_affine_times_hyperbolic_affine_matchers(void)
{
    ...
    ASSERT_TRUE(expr_match_affine_poly_deg4_times_unary_affine_kind(sinh_expr, EXPR_PATTERN_UNARY_SINH, 2, vars, poly,
                                                                    &constant, coeffs));
    ...
    ASSERT_TRUE(expr_match_affine_poly_deg4_times_unary_affine_kind(cosh_expr, EXPR_PATTERN_UNARY_COSH, 2, vars, poly,
                                                                    &constant, coeffs));
    ...
    ASSERT_TRUE(!expr_match_affine_poly_deg4_times_unary_affine_kind(mismatch, EXPR_PATTERN_UNARY_SINH, 2, vars, poly,
                                                                     &constant, coeffs));
    ASSERT_TRUE(!expr_match_affine_poly_deg4_times_unary_affine_kind(mismatch, EXPR_PATTERN_UNARY_COSH, 2, vars, poly,
                                                                     &constant, coeffs));
...
static void test_cube_affine_times_unary_affine_matchers(void)
{
    ...
    ASSERT_TRUE(expr_match_affine_poly_deg4_times_unary_affine_kind(exp_expr, EXPR_PATTERN_UNARY_EXP, 2, vars, poly,
                                                                    &constant, coeffs));
...
static void test_generic_affine_poly_deg4_times_unary_matcher(void)
{
    ...
    ASSERT_TRUE(expr_match_affine_poly_deg4_times_unary_affine_kind(expr, EXPR_PATTERN_UNARY_COSH, 2, vars, poly,
                                                                    &constant, coeffs));
    ...
    ASSERT_TRUE(!expr_match_affine_poly_deg4_times_unary_affine_kind(expr, (expr_pattern_unary_affine_kind_t)-1, 2,
                                                                     vars, poly, &constant, coeffs));
