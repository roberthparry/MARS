...
void test_extended_math_wrappers(void)
{
    ...
    print_mfloat_error_check("tan(0.5) mfloat error", c,
                             "0.");
    ASSERT_TRUE(mfloat_meets_precision(
        c,
        "0.",
        1));
    ...
    print_mfloat_error_check("sinh(0.5) mfloat error", c,
                             "0.");
    ASSERT_TRUE(mfloat_meets_precision(
        c,
        "0.",
        1));
    ...
    print_mfloat_error_check("sinhcosh(cosh, 0.5) mfloat error", cosh_pair,
                             "1.");
    ASSERT_TRUE(mfloat_meets_precision(
        sinh_pair,
        "0.",
        1));
    ...
    print_mfloat_error_check("atan(0.5) mfloat error", c,
                             "0.");
    ASSERT_TRUE(mfloat_meets_precision(
        c,
        "0.",
        1));
    ...
    print_mfloat_error_check("tanh(0.5) mfloat error", c,
                             "0.");
    ASSERT_TRUE(mfloat_meets_precision(
        c,
        "0.",
        1));
...

    {
        mfloat_t *asinh_expected = mf_create_string(
            "4.-01");
...

    {
        mfloat_t *acosh_expected = mf_create_string(
            "1.");
    ...
    print_mfloat_error_check("gammainc_P(1,1) mfloat error", f,
                             "0.");
    ASSERT_TRUE(mfloat_meets_precision(
        f,
        "0.",
        1));
    ...
    print_mfloat_error_check("atan2(1, -1) mfloat error", c,
                             "2.");
    ASSERT_TRUE(mfloat_meets_precision(
        c,
        "2.",
        1));
    ...
    ASSERT_TRUE(mfloat_matches_expected_bits(i,
                                             expected_calc,
                                             1,
                                             TEST_MFLOAT_MATHS_PRECISION - 8u));
    mf_free(expected_calc);
    expected_calc = NULL;

    ASSERT_EQ_INT(mf_set_string(i, "2.345"), 0);
    ASSERT_EQ_INT(mf_gamma(i), 0);
    print_mfloat_value("gamma(2.345)", i);
    print_mfloat_error_check("gamma(2.345) mfloat error", i,
    ...
    ASSERT_EQ_INT(mf_set_string(i, "2.345"), 0);
    ASSERT_EQ_INT(mf_lgamma(i), 0);
    print_mfloat_value("lgamma(2.345)", i);
    print_mfloat_error_check("lgamma(2.345) mfloat error", i,
    ...
    print_mfloat_error_check("trigamma(1) mfloat error", j,
                             "1.");
    ASSERT_TRUE(mfloat_meets_precision(
        j,
        "1.",
        1));
    ...
    print_mfloat_error_check("erf(0.5) mfloat error", c,
                             "0.");
    ASSERT_TRUE(mfloat_meets_precision(
        c,
        "0.",
        1));
    ...
    print_mfloat_error_check("erfc(0.5) mfloat error", c,
                             "0.");
    ASSERT_TRUE(mfloat_meets_precision(
        c,
        "0.",
        1));
...
void test_tetragamma_function(void)
{
    size_t saved_default = mf_get_default_precision();
    mfloat_t *x = NULL;
    ...
    ASSERT_EQ_INT(mf_tetragamma(x), 0);
    print_mfloat_value("tetragamma(2.345)", x);
    print_mfloat_error_check("tetragamma(2.345) mfloat error", x,
                             "-0.");
    ASSERT_TRUE(mfloat_meets_precision(
        x,
        "-0.",
        1));
...
void test_digamma_function(void)
{
    size_t saved_default = mf_get_default_precision();
    mfloat_t *x = NULL;
    ...
    ASSERT_EQ_INT(mf_digamma(x), 0);
    print_mfloat_value("digamma(2.345)", x);
    print_mfloat_error_check("digamma(2.345) mfloat error", x,
                             "-15.");
    ASSERT_TRUE(mfloat_meets_precision(
        x,
        "-15.",
        1));
...
void test_trigamma_function(void)
{
    size_t saved_default = mf_get_default_precision();
    mfloat_t *x = NULL;
    ...
    ASSERT_EQ_INT(mf_trigamma(x), 0);
    print_mfloat_value("trigamma(2.345)", x);
    print_mfloat_error_check("trigamma(2.345) mfloat error", x,
                             "0.");
    ASSERT_TRUE(mfloat_meets_precision(
        x,
        "0.",
        1));
...
void test_difficult_mfloat_cases(void)
{
    ...
    ASSERT_EQ_INT(mf_set_string(lhs, "3.345"), 0);
    ASSERT_EQ_INT(mf_lgamma(lhs), 0);
    ASSERT_EQ_INT(mf_set_string(rhs, "2.345"), 0);
    ASSERT_EQ_INT(mf_lgamma(rhs), 0);
    ASSERT_EQ_INT(mf_set_string(tmp, "2.345"), 0);
    ASSERT_EQ_INT(mf_log(tmp), 0);
    ASSERT_EQ_INT(mf_sub(lhs, rhs), 0);
    ASSERT_EQ_INT(mf_sub(lhs, tmp), 0);
    ASSERT_EQ_INT(mf_abs(lhs), 0);
    print_mfloat_error_check("lgamma(3.345) - lgamma(2.345) - log(2.345) mfloat error", lhs, "0");
...
void test_gamma_family(void)
{
    mfloat_t *i = NULL;
    mfloat_t *expected_calc = NULL;
    size_t saved_default;

    saved_default = mf_get_default_precision();
    ASSERT_EQ_INT(mf_set_default_precision(TEST_MFLOAT_MATHS_PRECISION), 0);

    i = mf_new_prec(TEST_MFLOAT_MATHS_PRECISION);
    ASSERT_NOT_NULL(i);
...
void test_gamma_identities(void)
{
    mfloat_t *lhs = NULL;
    mfloat_t *rhs = NULL;
    mfloat_t *tmp = NULL;
