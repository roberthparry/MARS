...
{
    char *prime = mint_to_string(factor->prime);
...
{
    mint_t *zero = mint_new();
    mint_t *pow2_zero = mint_create_2pow(0);
    mint_t *pos = mint_create_long(65);
    mint_t *pow2_small = mint_create_2pow(5);
    mint_t *pow2_big = mint_create_2pow(64);
    mint_t *pow2_huge = mint_create_2pow(127);
    mint_t *neg = mint_create_long(-12345);
    mint_t *big = mint_create_string("18446744073709551616");
...
{
    mint_t *u = mint_create_ulong(ULONG_MAX);
    mint_t *h = mint_create_hex("0x10000000000000000");
    mint_t *m = mint_new();
    ...
    ASSERT_EQ_INT(mint_set_ulong(m, 42ul), 0);
...
void test_clone_copies_value(void)
{
    ...
    ASSERT_EQ_INT(mint_add(b, MNT_ONE), 0);
    print_mint_input("a after mint_add(b, 1)", a);
    print_mint_input("b after mint_add(b, 1)", b);
...
{
    mint_t *a = mint_create_string("18446744073709551616");
    mint_t *b = mint_create_long(5);
    mint_t *c = mint_create_long(-100);
    mint_t *d = mint_create_long(30);
    mint_t *e = mint_create_long(50);
    mint_t *f = mint_create_long(-50);
...
{
    mint_t *a = mint_create_string("18446744073709551616");
    mint_t *b = mint_create_long(10);
    mint_t *c = mint_create_long(-12);
    mint_t *d = mint_create_long(-12);
...
{
    mint_t *a = mint_create_string("18446744073709551621");
    mint_t *b = mint_create_long(10);
    mint_t *rem = mint_new();
    mint_t *c = mint_create_long(-17);
    mint_t *d = mint_create_long(5);
    mint_t *modv = mint_create_long(100);
    mint_t *modd = mint_create_long(9);
    long rem_long = 0;
    ...
    ASSERT_EQ_INT(mint_div(a, b, rem), 0);
    print_mint_input("a after a /= b", a);
    ...
    ASSERT_EQ_INT(mint_div(c, d, rem), 0);
    print_mint_input("c after c /= d", c);
...
{
    mint_t *a = mint_create_long(12);
    mint_t *b = mint_create_long(-2);
    mint_t *c = mint_create_long(123);
...
{
    mint_t *a = mint_create_long(5);
    mint_t *b = mint_create_long(-7);
    mint_t *c = mint_create_long(5);
...
{
    mint_t *a = mint_create_long(0);
    mint_t *b = mint_create_string("18446744073709551616");
    mint_t *c = mint_create_long(-2);
    ...
    ASSERT_EQ_INT(mint_inc(a), 0);
    print_mint_input("a after inc", a);
    assert_mint_string(a, "1");

    ASSERT_EQ_INT(mint_dec(a), 0);
    print_mint_input("a after dec", a);
    assert_mint_string(a, "0");

    print_mint_input("c before dec", c);
    ASSERT_EQ_INT(mint_dec(c), 0);
    print_mint_input("c after dec", c);
    assert_mint_string(c, "-3");

    print_mint_input("b for bit tests", b);
    ASSERT_EQ_LONG((long)mint_bit_length(a), 0);
    ASSERT_EQ_LONG((long)mint_bit_length(b), 65);
    ASSERT_TRUE(mint_test_bit(b, 64));
    ASSERT_TRUE(!mint_test_bit(b, 63));
    ASSERT_TRUE(!mint_test_bit(c, 100));
...
{
    mint_t *a = mint_create_long(3);
    mint_t *b = mint_create_string("18446744073709551616");
    mint_t *c = mint_create_long(-9);
...
{
    mint_t *a = mint_create_long(144);
    mint_t *b = mint_create_long(200);
    mint_t *c = mint_create_string("18446744073709551616");
...
{
    mint_t *a = mint_create_long(13);
    mint_t *b = mint_create_long(11);
    mint_t *c = mint_create_long(13);
    mint_t *d = mint_create_long(11);
    mint_t *e = mint_create_long(13);
    mint_t *f = mint_create_long(8);
...
{
    mint_t *base = mint_create_long(4);
    mint_t *exp = mint_create_long(13);
    mint_t *mod = mint_create_long(497);
    mint_t *prime = mint_create_long(97);
    mint_t *composite = mint_create_long(221);
    mint_t *big_prime = mint_create_long(999983);
    mint_t *big_composite = mint_create_long(999985);
    mint_t *ec_prime = mint_create_long(137);
    mint_t *carmichael = mint_create_long(561);
    mint_t *fermat_composite = mint_create_string("18446744073709551617");
    mint_t *mersenne_127 = mint_create_2pow(127);
    mint_t *mersenne_67 = mint_create_2pow(67);
    mint_t *minus_one = mint_create_long(-1);
    mint_t *n = mint_create_long(360);
    mint_t *big_n = mint_create_string("1000036000099");
    ...
    ASSERT_EQ_INT(mint_powmod(base, exp, mod), 0);
    print_mint_input("base after base^exp mod mod", base);
    assert_mint_string(base, "445");

    print_mint_input("prime candidate", prime);
    ASSERT_TRUE(mint_isprime(prime));
    ASSERT_EQ_INT(mint_prove_prime(prime), MINT_PRIMALITY_PRIME);

    print_mint_input("composite candidate", composite);
    ASSERT_TRUE(!mint_isprime(composite));
    ASSERT_EQ_INT(mint_prove_prime(composite), MINT_PRIMALITY_COMPOSITE);

    print_mint_input("large prime candidate", big_prime);
    ASSERT_TRUE(mint_isprime(big_prime));

    print_mint_input("large composite candidate", big_composite);
    ASSERT_TRUE(!mint_isprime(big_composite));

    print_mint_input("n+1 EC candidate", ec_prime);
    ASSERT_TRUE(mint_isprime(ec_prime));
    ASSERT_EQ_INT(mint_prove_prime(ec_prime), MINT_PRIMALITY_PRIME);

    print_mint_input("carmichael candidate", carmichael);
    ASSERT_TRUE(!mint_isprime(carmichael));
    ASSERT_EQ_INT(mint_prove_prime(carmichael), MINT_PRIMALITY_COMPOSITE);

    print_mint_input("F5 composite candidate", fermat_composite);
    ASSERT_TRUE(!mint_isprime(fermat_composite));
    ASSERT_EQ_INT(mint_prove_prime(fermat_composite), MINT_PRIMALITY_COMPOSITE);

    ASSERT_EQ_INT(mint_add(mersenne_127, minus_one), 0);
    print_mint_input("M_127 candidate", mersenne_127);
    ASSERT_TRUE(mint_isprime(mersenne_127));
    ASSERT_EQ_INT(mint_prove_prime(mersenne_127), MINT_PRIMALITY_PRIME);

    ASSERT_EQ_INT(mint_add(mersenne_67, minus_one), 0);
    print_mint_input("M_67 candidate", mersenne_67);
    ASSERT_TRUE(!mint_isprime(mersenne_67));
    ASSERT_EQ_INT(mint_prove_prime(mersenne_67), MINT_PRIMALITY_COMPOSITE);

    print_mint_input("n before factors", n);
    factors = mint_factors(n);
    ...
    mint_free(composite);
    mint_free(big_prime);
    mint_free(big_composite);
    mint_free(ec_prime);
    mint_free(carmichael);
    mint_free(fermat_composite);
    mint_free(mersenne_127);
    mint_free(mersenne_67);
    mint_free(minus_one);
    mint_free(n);
    mint_free(big_n);
}
...
{
    mint_t *a = mint_create_long(100);
    mint_t *b = mint_create_long(30);
    mint_t *c = mint_create_long(-42);
    mint_t *d = mint_create_string("9223372036854775808");
    mint_t *g = mint_create_long(84);
    mint_t *h = mint_create_long(30);
    mint_t *l = mint_create_long(-21);
    mint_t *m = mint_create_long(6);
    long value = 0;
    ...
    ASSERT_EQ_INT(mint_sub(a, b), 0);
    print_mint_input("a after a -= b", a);
    assert_mint_string(a, "70");

    print_mint_input("c before abs", c);
    ASSERT_EQ_INT(mint_abs(c), 0);
    print_mint_input("c after abs", c);
    assert_mint_string(c, "42");

    ASSERT_TRUE(!mint_is_zero(a));
    ASSERT_TRUE(mint_is_zero(MNT_ZERO));
    ASSERT_TRUE(!mint_is_negative(a));
    ASSERT_TRUE(mint_is_even(c));
    ASSERT_TRUE(!mint_is_odd(c));

    ASSERT_TRUE(mint_fits_long(c));
    ASSERT_TRUE(mint_get_long(c, &value));
    printf("    expected long = 42\n");
    printf("    got long      = %ld\n", value);
    ASSERT_EQ_LONG(value, 42);

    ASSERT_TRUE(!mint_fits_long(d));
    ASSERT_TRUE(!mint_get_long(d, &value));

    print_mint_input("g before gcd", g);
    print_mint_input("h before gcd", h);
    ASSERT_EQ_INT(mint_gcd(g, h), 0);
    print_mint_input("g after gcd(g, h)", g);
    assert_mint_string(g, "6");

    print_mint_input("l before lcm", l);
    print_mint_input("m before lcm", m);
    ASSERT_EQ_INT(mint_lcm(l, m), 0);
...
{
    mint_t *n = mint_create_long(123);
    mint_t *d = mint_create_long(10);
    mint_t *q = mint_new();
    mint_t *r = mint_new();
    mint_t *sq = mint_create_long(-12);
    mint_t *a = mint_create_long(240);
    mint_t *b = mint_create_long(46);
    mint_t *g = mint_new();
    mint_t *x = mint_new();
    mint_t *y = mint_new();
    mint_t *lhs = mint_clone(a);
    mint_t *rhs = mint_clone(b);
    mint_t *inv = mint_create_long(3);
    mint_t *mod = mint_create_long(11);
    mint_t *check = mint_clone(inv);
    ...
    ASSERT_EQ_INT(mint_divmod(n, d, q, r), 0);
    ...
    ASSERT_EQ_INT(mint_square(sq), 0);
    ...
    ASSERT_EQ_INT(mint_gcdext(g, x, y, a, b), 0);
    ...
    ASSERT_EQ_INT(mint_mul(lhs, x), 0);
    ASSERT_EQ_INT(mint_mul(rhs, y), 0);
    ASSERT_EQ_INT(mint_add(lhs, rhs), 0);
    ...
    ASSERT_EQ_INT(mint_modinv(inv, mod), 0);
    print_mint_input("inv after modinv", inv);
    assert_mint_string(inv, "4");

    ASSERT_EQ_INT(mint_mul(check, inv), 0);
    ASSERT_EQ_INT(mint_mod(check, mod), 0);
...
void test_readme_mersenne_prime_search(void)
{
    ...
    for (p = 2; p <= 19937; ++p) {
        ...
        if (mint_isprime(exp)) {
            ...
            ASSERT_EQ_INT(mint_add(mersenne, minus_one), 0);
