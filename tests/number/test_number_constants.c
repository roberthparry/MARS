...
void run_number_constant_tests(void)
{
...

    {
        ...
        ASSERT_TRUE(num_eq(sin_pi_6_pair, NUM_HALF));
        ASSERT_TRUE(num_eq(cos_pi_6_pair, half_sqrt3));
        ...
        ASSERT_TRUE(num_eq(sinh_i_pi_3_pair, i_half_sqrt3));
        ASSERT_TRUE(num_eq(cosh_i_pi_3_pair, NUM_HALF));
