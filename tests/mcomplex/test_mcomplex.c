...
static void test_difficult_mcomplex_cases(void)
{
    ...
    z = mc_create_string("1.25 + 0.5i");
    other = mc_create_string("0.75 + 0.25i");
    expected = mc_clone(z);
    rhs = mc_clone(other);
    ASSERT_NOT_NULL(z);
    ASSERT_NOT_NULL(other);
    ...
    ASSERT_NOT_NULL(rhs);
    ASSERT_NOT_NULL(expected);
    ASSERT_EQ_INT(mc_gammainc_lower(lhs, other), 0);
    ASSERT_EQ_INT(mc_gammainc_upper(rhs, other), 0);
    ASSERT_EQ_INT(mc_add(lhs, rhs), 0);
    ...
    ASSERT_NOT_NULL(lhs);
    ASSERT_NOT_NULL(rhs);
    ASSERT_EQ_INT(mc_gammainc_P(lhs, other), 0);
