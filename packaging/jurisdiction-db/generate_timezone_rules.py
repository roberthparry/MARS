...
LOCATION_SQL_PATH = Path("packaging/jurisdiction-db/mars_jurisdiction_location_defaults.sql")
OUT_PATH = Path("packaging/jurisdiction-db/mars_timezone_rules.sql")
