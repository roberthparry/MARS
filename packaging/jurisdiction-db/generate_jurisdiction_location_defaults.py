...
OUT_PATH = Path("packaging/jurisdiction-db/mars_jurisdiction_location_defaults.sql")
COUNTRY_SQL_PATH = Path("packaging/jurisdiction-db/mars_country_jurisdictions.sql")
...
def main() -> None:
    rows = build_rows()
    lines = [
        "-- Generated by packaging/jurisdiction-db/generate_jurisdiction_location_defaults.py",
