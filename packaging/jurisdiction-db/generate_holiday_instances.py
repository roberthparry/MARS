...
OUT_PATH = "packaging/jurisdiction-db/mars_generated_holiday_instances.sql"
SUBDIVISION_OUT_PATH = "packaging/jurisdiction-db/mars_target_subdivisions.sql"
RULES_OUT_PATH = "packaging/jurisdiction-db/mars_generated_first_class_rules.sql"
...
def generate_first_class_rules() -> None:
    ...
    with open(RULES_OUT_PATH, "w", encoding="utf-8") as handle:
        handle.write("-- Generated by packaging/jurisdiction-db/generate_holiday_instances.py\n")
